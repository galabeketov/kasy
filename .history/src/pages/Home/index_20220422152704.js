    ...
    <>
      ...
      <section className="section home" id="home">
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="home-shape-arrow w-100  ">
              <a
                href="#features"
                className="mouse-down d-flex justify-content-center align-items-center"
              >
                <FaArrowDown className="arrow-icon text-dark h5 " />
              </a>
            </div>
          </div>
          {/* <!--end row--> */}
