              ...
              <div className="footer-subcribe text-end shadow-sm d-inline-block">
                <form action="javascript:void(0)">
                  ...
                  <button type="submit" className="btn btn-primary">
                    <MdNotificationsActive style={{ fontSize: "inherit" }} />
                  </button>
                </form>
              </div>
                ...
                <ul className="list-inline footer-social mb-0">
                  <li className="list-inline-item">
                    <a href="javascript:void(0)" className="rounded">
                      <FaFacebook style={{ color: "#1a3365" }} />
                    </a>
                  </li>

                  <li className="list-inline-item">
                    <a href="javascript:void(0)" className="rounded">
                      <FaLinkedin style={{ color: "#1a3365" }} />
                    </a>
                  </li>

                  <li className="list-inline-item">
                    <a href="javascript:void(0)" className="rounded">
                      <FaPinterest style={{ color: "#1a3365" }} />
                    </a>
                  </li>

                  <li className="list-inline-item">
                    <a href="javascript:void(0)" className="rounded">
                      <FaTwitter style={{ color: "#1a3365" }} />
                    </a>
                  </li>
                </ul>
              </div>
